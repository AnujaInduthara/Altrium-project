// Shared inline-SVG icon set. Each entry is the *inner* markup of a
// 24x24 outline icon (stroke = currentColor), so callers wrap it:
//
//   `<svg viewBox="0 0 24 24" ...>${ICONS.dashboard}</svg>`
//
// Keeping them here means one place to swap the icon style project-wide.
...
// Convenience: full <svg> wrapper around an icon key.
